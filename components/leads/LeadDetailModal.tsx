            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              {!deletingConfirm ? (
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button onClick={() => setDeletingConfirm(false)} className="px-2 py-1 text-xs text-zinc-500 hover:text-zinc-300 rounded transition-all">Non</button>
                </div>
              )}
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {lead.phone && (
                    <a href={`tel:${lead.phone}`} className="flex items-center gap-2 p-3 bg-zinc-900 rounded-xl border border-zinc-800 hover:border-zinc-600 transition-all group">
                      <Phone className="w-4 h-4 text-zinc-500 group-hover:text-emerald-400 transition-colors" />
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800">
                    <p className="text-[10px] text-zinc-600 mb-1">Source</p>
                    <p className="text-xs font-medium text-zinc-300">{SOURCE_ICONS[lead.source]} {lead.source}</p>
                  </div>
                  {lead.budget && (
                    <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800">
                      <p className="text-[10px] text-zinc-600 mb-1">Budget estimé</p>
                      <p className="text-xs font-medium text-zinc-300">{lead.budget}</p>
                    </div>
                  )}
                  {lead.timeline && (
                    <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800">
                      <p className="text-[10px] text-zinc-600 mb-1">Timeline</p>
                      <p className="text-xs font-medium text-zinc-300">{lead.timeline}</p>
                    </div>
                  )}
                  <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800">
                    <p className="text-[10px] text-zinc-600 mb-1">Créé le</p>
                ...
                {/* Proposition amount */}
                <div>
                  <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">Montant proposition</p>
                ...
                <div className="pt-2 border-t border-zinc-800 space-y-3">
                  <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Actions IA</p>
                  <button
