        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Identité</p>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="text-xs text-zinc-500 mb-1 block">Entreprise</label>
                ...
                <div>
                  <label className="text-xs text-zinc-500 mb-1 block">Téléphone</label>
            ...
            {/* Commercial */}
            <div className="space-y-3">
              <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Commercial</p>
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  <label className="text-xs text-zinc-500 mb-1 block">Budget estimé</label>
                ...
                <div>
                  <label className="text-xs text-zinc-500 mb-1 block">Timeline</label>
