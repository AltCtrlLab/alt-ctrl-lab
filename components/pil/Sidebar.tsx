  ...
  const sections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'activity', icon: BarChart3, label: 'Activité', shortcut: '4' },
    ...
    },
    {
      title: 'Système',
      items: [
        { id: 'rd', icon: Lightbulb, label: 'Labo R&D', shortcut: '6', badge: badges.proposals },
        { id: 'assets', icon: Database, label: 'La Voûte', shortcut: '7' },
        { id: 'constellation', icon: Network, label: 'Constellation' },
        { id: 'analytics', icon: Coins, label: 'Analytique Tokens' },
        { id: 'burnrate', icon: Flame, label: 'Burn Rate' },
        { id: 'timeline', icon: GitGraph, label: 'Timeline Agents' },
        { id: 'performance', icon: UserCheck, label: 'Performance' },
        { id: 'vault-analytics', icon: PieChart, label: 'Analytique Vault' },
        { id: 'replay', icon: History, label: 'Rejeu War Room' },
        { id: 'health', icon: Activity, label: 'Santé Système' },
        { id: 'settings', icon: Settings, label: 'Réglages', shortcut: '8' },
      ],
    },
  ];
